...
void* W2(void* )
{
	...
	while(true){
		...
		strcpy(ms1.msg,"P2\0");
		strcat(ms1.msg,ms);
		cout<<"Message delievered from C2:"<<ms1.msg<<endl;
...
void* R2(void* )
{
	...
	{
		msg_buf ms2;
		msgrcv(msg_id1,&ms2,sizeof(ms2),4,0);
		cout<<"Message Received in C2"<<ms2.msg<<endl;
	}
}
...
void* G1(void* )
{
	...
	{
		msg_buf ms2;
		msgrcv(msg_id3,&ms2,sizeof(ms2),4,0);
