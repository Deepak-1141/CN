...
void* W2(void* )
{
	...
	while(true)
	{
		...
		strcpy(ms1.msg,"B2\0");
		strcat(ms1.msg,ms);
		cout<<"Message delievered from C5:"<<ms1.msg<<endl;
...
void* R2(void* )
{
	...
	{
		msg_buf ms2;
		msgrcv(msg_id2,&ms2,sizeof(ms2),4,0);
		cout<<"Message Received in C5"<<ms2.msg<<endl;
	}
}
void* G2(void* )
{
	...
	{
		msg_buf ms2;
		msgrcv(msg_id3,&ms2,sizeof(ms2),7,0);
...
{
	pthread_t t1,t2,t3;
	pthread_create(&t1,NULL,W2,NULL);
