...
void* W3(void* )
{
	...
	while(true)
	{
		...
		strcpy(ms1.msg,"B3\0");
		strcat(ms1.msg,ms);
		cout<<"Message delievered from C6:"<<ms1.msg<<endl;
...
void* R3(void* )
{
	...
	{
		msg_buf ms2;
		msgrcv(msg_id2,&ms2,sizeof(ms2),5,0);
		cout<<"Message Received in C6"<<ms2.msg<<endl;
	}
}
void* G2(void* )
{
	...
	{
		msg_buf ms2;
		msgrcv(msg_id3,&ms2,sizeof(ms2),8,0);
