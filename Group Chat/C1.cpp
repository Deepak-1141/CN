...
// NOTE:: Address for processes 1000=>G1,1001=>G2,1002=>Global
...
void* W1(void* )
{
	...
	while(true){
		...
		strcpy(ms1.msg,"P1\0");
		strcat(ms1.msg,ms);
		cout<<"Message delievered from C1:"<<ms1.msg<<endl;
...
void* R1(void* )
{
	...
	{
		msg_buf ms2;
		msgrcv(msg_id1,&ms2,sizeof(ms2),3,0);
		cout<<"Message Received in C1"<<ms2.msg<<endl;
	}
}
void* G1(void* )
{
	...
	{
		msg_buf ms2;
		msgrcv(msg_id3,&ms2,sizeof(ms2),3,0);
